...
Shader "Vincent/Road_ASE"
{
	Properties
	{
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[ASEBegin][Header(Road)]_RoadTex("Road Tex", 2D) = "white" {}
		_RoadNormal("Road Normal", 2D) = "white" {}
		...
		[Header(Inner Line)]_InnerLineColor("Inner Line Color", Color) = (0.9535638,1,0.2971698,1)
		_InnerLineWidth("Inner Line Width", Range( 0.01 , 0.3)) = 0.01
		_InnerRoadOffset("Inner Road Offset", Range( 0.02 , 0.2)) = 0.08
		[Header(Dash Line)]_DashLineColor("Dash Line Color", Color) = (1,1,1,1)
		_DashLineWidth("Dash Line Width", Range( 0.01 , 0.3)) = 0.01
		_DashSegmentLength("Dash Segment Length", Float) = 0.5
		_DashLineOffset("Dash Line Offset", Float) = 2.08
		[ASEEnd]_DashLineCount("Dash Line Count", Float) = 4.21
