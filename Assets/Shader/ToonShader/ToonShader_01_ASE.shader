...
Shader "Vincent/Toon/ToonShader_01_ASE"
{
	Properties
	{
		...
		_SpecArea("Spec Area", Range( 0 , 1)) = 0.25
		_SpecIntensity("Spec Intensity", Range( 0 , 1)) = 0.05
		_SpecMap("Spec Map", 2D) = "white" {}
		_SpecColor("Spec Color", Color) = (1,1,1,1)
		[ASEEnd]_SpecColorLerp("Spec Color Lerp", Range( 0 , 1)) = 0.45
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_135_0 = ( ( Lightning85 + RimLight99 ) + Spec126 );
...
/*ASEBEGIN
Version=18935
0;73;1920;928;1656.425;-1878.227;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-2126.058,1300.732;Inherit;False;Property;_RimOffset;Rim Offset;5;0;Create;True;0;0;0;False;0;False;0.75;0.75;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;78;-3106.084,-1146.938;Inherit;False;Property;_Tint;Tint;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;75;-3111.793,-940.1475;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;ae211dcf9923bad4c93a8a0a469214df;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.BreakToComponentsNode;138;2381.416,65.20758;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-1430.428,2355.411;Inherit;False;Property;_SpecArea;Spec Area;8;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;104;-855.8822,1676.831;Inherit;False;Property;_RimTint;Rim Tint;7;0;Create;True;0;0;0;False;0;False;0.3191082,0.8266167,0.9528302,1;0.3191081,0.8266167,0.9528301,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;131;-878.3574,2706.545;Inherit;False;Property;_SpecColor;Spec Color;11;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-884.3574,3075.545;Inherit;False;Property;_SpecColorLerp;Spec Color Lerp;12;0;Create;True;0;0;0;False;0;False;0.45;0.45;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-5.918014,2371.938;Inherit;False;Property;_SpecIntensity;Spec Intensity;9;0;Create;True;0;0;0;False;0;False;0.05;0.15;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D2DCF2DDF474B04BF8CAFA57AB01D6F21B7F0CC9