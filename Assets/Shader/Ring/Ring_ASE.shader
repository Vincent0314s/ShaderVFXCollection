...
Shader "Vincent/Ring_ASE"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin][HDR]_RingColor("Ring Color", Color) = (0.2160373,1,0,1)
		_Radius("Radius", Range( 0 , 1)) = 0.3678592
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord10 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( -0.5,-0.5 );
				float temp_output_28_0 = step( ( abs( ( distance( texCoord10 , float2( 0,0 ) ) - _Radius ) ) - _Width ) , 0.03 );
				float4 Albedo38 = ( ( _RingColor * IN.ase_color ) * temp_output_28_0 );
				
				float Alpha30 = ( IN.ase_color.a * temp_output_28_0 );
				
				float3 Albedo = Albedo38.rgb;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( -0.5,-0.5 );
				float temp_output_28_0 = step( ( abs( ( distance( texCoord10 , float2( 0,0 ) ) - _Radius ) ) - _Width ) , 0.03 );
				float Alpha30 = ( IN.ase_color.a * temp_output_28_0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( -0.5,-0.5 );
				float temp_output_28_0 = step( ( abs( ( distance( texCoord10 , float2( 0,0 ) ) - _Radius ) ) - _Width ) , 0.03 );
				float Alpha30 = ( IN.ase_color.a * temp_output_28_0 );
...
/*ASEBEGIN
Version=18935
0;73;1600;748;2766.285;575.1984;2.649176;True;False
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-2486.218,60.55167;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;-0.5,-0.5;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;13;-2113.346,328.8444;Inherit;False;Property;_Radius;Radius;1;0;Create;True;0;0;0;False;0;False;0.3678592;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;11;-2200.219,55.55165;Inherit;True;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;16;-1392.771,347.6122;Inherit;False;Property;_Width;Width;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;32;-692.5005,-230.2583;Inherit;False;Property;_RingColor;Ring Color;0;1;[HDR];Create;True;0;0;0;False;0;False;0.2160373,1,0,1;0.2160373,1,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;36;-674.9172,-30.75287;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-280.6382,-82.24524;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StepOpNode;28;-711.85,212.4117;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0.03;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;-83.48596,8.538361;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;-401.9865,236.3962;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;30;-211.9634,343.0563;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;29;-2228.927,-706.8103;Inherit;False;720.7692;304;Comment;2;9;8;AnotherWayToCenterUV;1,1,1,1;0;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;38;178.1497,10.87982;Inherit;True;Albedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;31;654.0084,527.6146;Inherit;False;30;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;8;-2178.927,-650.4355;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;39;660.7819,208.864;Inherit;False;38;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.TFHCRemapNode;9;-1798.159,-656.8104;Inherit;True;5;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT2;1,1;False;3;FLOAT2;-1,-1;False;4;FLOAT2;1,1;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=3F387BA91BA5FE870F3C06E937ECC3441F206861